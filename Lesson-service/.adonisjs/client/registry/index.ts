...
const routes = {
  ...
  'files.index': {
    ...
    tokens: [{"old":"/api/v1/lessons/byId/:id/files","type":0,"val":"api","end":""},{"old":"/api/v1/lessons/byId/:id/files","type":0,"val":"v1","end":""},{"old":"/api/v1/lessons/byId/:id/files","type":0,"val":"lessons","end":""},{"old":"/api/v1/lessons/byId/:id/files","type":0,"val":"byId","end":""},{"old":"/api/v1/lessons/byId/:id/files","type":1,"val":"id","end":""},{"old":"/api/v1/lessons/byId/:id/files","type":0,"val":"files","end":""}],
