...
const routes = {
  ...
  'lessons.show_by_author': {
    ...
    tokens: [
      { old: '/api/v1/lessons/cnt/:author', type: 0, val: 'api', end: '' },
      { old: '/api/v1/lessons/cnt/:author', type: 0, val: 'v1', end: '' },
      { old: '/api/v1/lessons/cnt/:author', type: 0, val: 'lessons', end: '' },
      { old: '/api/v1/lessons/cnt/:author', type: 0, val: 'cnt', end: '' },
      { old: '/api/v1/lessons/cnt/:author', type: 1, val: 'author', end: '' },
    ],
  ...
  'lessons.show_by_content': {
    ...
    tokens: [
      { old: '/api/v1/lessons/cnt/:author/:content', type: 0, val: 'api', end: '' },
      { old: '/api/v1/lessons/cnt/:author/:content', type: 0, val: 'v1', end: '' },
      { old: '/api/v1/lessons/cnt/:author/:content', type: 0, val: 'lessons', end: '' },
      { old: '/api/v1/lessons/cnt/:author/:content', type: 0, val: 'cnt', end: '' },
      { old: '/api/v1/lessons/cnt/:author/:content', type: 1, val: 'author', end: '' },
      { old: '/api/v1/lessons/cnt/:author/:content', type: 1, val: 'content', end: '' },
    ],
  ...
  'lessons.show_by_id': {
    ...
    tokens: [
      { old: '/api/v1/lessons/byId/:id', type: 0, val: 'api', end: '' },
      { old: '/api/v1/lessons/byId/:id', type: 0, val: 'v1', end: '' },
      { old: '/api/v1/lessons/byId/:id', type: 0, val: 'lessons', end: '' },
      { old: '/api/v1/lessons/byId/:id', type: 0, val: 'byId', end: '' },
      { old: '/api/v1/lessons/byId/:id', type: 1, val: 'id', end: '' },
    ],
  ...
  'files.index': {
    ...
    tokens: [
      { old: '/api/v1/lessons/byId/:id/files', type: 0, val: 'api', end: '' },
      { old: '/api/v1/lessons/byId/:id/files', type: 0, val: 'v1', end: '' },
      { old: '/api/v1/lessons/byId/:id/files', type: 0, val: 'lessons', end: '' },
      { old: '/api/v1/lessons/byId/:id/files', type: 0, val: 'byId', end: '' },
      { old: '/api/v1/lessons/byId/:id/files', type: 1, val: 'id', end: '' },
      { old: '/api/v1/lessons/byId/:id/files', type: 0, val: 'files', end: '' },
    ],
    types: placeholder as Registry['files.index']['types'],
  },
  'files.store': {
    methods: ['POST'],
    pattern: '/api/v1/lessons/byId/:id/files',
