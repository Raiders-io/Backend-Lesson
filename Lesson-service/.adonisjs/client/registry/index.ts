...
const routes = {
  ...
  'lessons.show_by_author': {
    ...
    tokens: [{"old":"/api/v1/lessons/:author","type":0,"val":"api","end":""},{"old":"/api/v1/lessons/:author","type":0,"val":"v1","end":""},{"old":"/api/v1/lessons/:author","type":0,"val":"lessons","end":""},{"old":"/api/v1/lessons/:author","type":1,"val":"author","end":""}],
    types: placeholder as Registry['lessons.show_by_author']['types'],
  },
  'lessons.show': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/lessons/:author/:contentId',
    tokens: [{"old":"/api/v1/lessons/:author/:contentId","type":0,"val":"api","end":""},{"old":"/api/v1/lessons/:author/:contentId","type":0,"val":"v1","end":""},{"old":"/api/v1/lessons/:author/:contentId","type":0,"val":"lessons","end":""},{"old":"/api/v1/lessons/:author/:contentId","type":1,"val":"author","end":""},{"old":"/api/v1/lessons/:author/:contentId","type":1,"val":"contentId","end":""}],
  ...
  'lessons.update': {
    ...
    tokens: [{"old":"/api/v1/lessons/:contentId","type":0,"val":"api","end":""},{"old":"/api/v1/lessons/:contentId","type":0,"val":"v1","end":""},{"old":"/api/v1/lessons/:contentId","type":0,"val":"lessons","end":""},{"old":"/api/v1/lessons/:contentId","type":1,"val":"contentId","end":""}],
